<!-- Устанавливая опцию "Allow edits and access to secrets by maintainers" вы даете разрешение мейнтейнерам применять изменения на вашей ветке без явного оповещения. -->
